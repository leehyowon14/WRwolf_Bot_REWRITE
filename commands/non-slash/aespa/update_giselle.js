...
async function fetchAllMessages(bot) {
    const channel = bot.channels.cache.get("992999485204606996");
    let messages = [];
    ...
    console.log("get all winter picture's link successfully");
    return messages;
} //https://stackoverflow.com/questions/63322284/discord-js-get-an-array-of-all-messages-in-a-channel

module.exports = {
    config: {
        name: `${prefix}update_giselle`,
        description: "get winter image",
        usage: "!update_giselle",
        accessableby: "Admin",
    },
    run: async (bot, message, args) => {
        ...
        fetchAllMessages(bot).then(msgs => {
          ...
          fs.writeFile('./commands/non-slash/aespa/json/giselle.json', json, 'utf-8', function(error) {
        ...
        let embed = new MessageEmbed()
          ...
          .setDescription(`giselle's image has been updated successfully`)
          .setColor('#57F287')
